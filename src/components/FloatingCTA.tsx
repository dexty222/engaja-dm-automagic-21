...
export const FloatingCTA = () => {
  ...
  return <>
      ...
      <div className="fixed bottom-4 left-4 right-4 z-50 md:hidden animate-slide-in-right">
        <Button variant="cta" size="lg" className="w-full group shadow-glow" onClick={() => window.open('https://pay.kiwify.com.br/sey169c', '_blank')}>
          🚀 Comprar por R$ 47
      ...
      <div className="fixed bottom-6 right-6 z-50 hidden md:block animate-scale-in">
        <Button variant="floating" size="icon" className="group shadow-glow animate-pulse-glow" onClick={() => window.open('https://pay.kiwify.com.br/sey169c', '_blank')} title="Comprar EngajaDM por R$ 47">
          💰
        </Button>
      </div>
